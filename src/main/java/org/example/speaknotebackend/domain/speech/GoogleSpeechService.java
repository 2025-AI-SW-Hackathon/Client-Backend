package org.example.speaknotebackend.domain.speech;
...
import org.example.speaknotebackend.domain.annotation.model.request.AnnotationCallbackRequest;
import org.example.speaknotebackend.domain.lecture.LectureRepository;
import org.example.speaknotebackend.domain.speech.util.SttTextBuffer;
...
public class GoogleSpeechService {
     ...
     */
    public void enqueueOutboundFromCallback(AnnotationCallbackRequest.AnnotationResult result) {
